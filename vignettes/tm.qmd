...
vignette: >
  ...
  %\VignetteDepends{TransitionModels}
...
In this vignette, we will demonstrate the implementation and application of transition models using the `TransitionModels` package. The following sections provide practical examples and insights into their flexibility and versatility.
