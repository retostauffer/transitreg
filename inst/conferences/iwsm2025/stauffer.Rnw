...
probability of rain during in Limerick the conference week (July 14--18) is
$68.7\%$, with a $44.2\%$ chance of receiving more than $1\,\mathrm{mm}$ and an
expected daily amount of $1.44\,\mathrm{mm}$.
...
with a $44.2\%$ chance of receiving more than $1\,\mathrm{mm}$ and an expected
daily amount of $1.44\,\mathrm{mm}$.
