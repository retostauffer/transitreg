...
\begin{frame}[fragile]
    ...
    \begin{center}
        \includegraphics[width = .9\textwidth]{shannon-estim}
    \end{center}

Climatological estimates for Limerick during conference week (July 14--18):
\medskip

\begin{itemize}
    \item A $68.7\%$ probability of getting rain,
    \item a $44.2\%$ chance of receiving more than $1\,\text{mm}\,\text{day}^{-1}$,
    \item with an expected amount of $1.44\,\text{mm}\,\text{day}^{-1}$.
\end{itemize}
