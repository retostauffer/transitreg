...
doubleVec treg_calc_pdf(int* positions, int count, double* tpptr, double* binsptr, double* y, int ny);
doubleVec treg_calc_cdf(int* positions, int count, double* tpptr, double* binsptr, double* y, int ny);
